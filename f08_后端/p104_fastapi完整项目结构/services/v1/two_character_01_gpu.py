...
def generate_image(prompt, width, height,
    ...
    def on_open(ws): # 在打开的时候提交生成任务
        ...
        try:
            # 打开工作流文件
            with open('services/comfyui_api/two_character_01_api.json', 'r',encoding='utf-8') as f:
            ...
            work_flow['26']['inputs']['noise_seed'] = random.randint(0, 4294967295) # 设置随机种子
            work_flow['35']['inputs']['input_str'] = prompt # 提示词
            work_flow['36']['inputs']['input_int'] = width # 宽
            work_flow['37']['inputs']['input_int'] = height # 高

            work_flow['11']['inputs']['unet_name'] = checkpoint_name
            work_flow['18']['inputs']['lora_name'] = lora_name
...
# white pants,
# '''
# a = generate_image(prompt=prompt, width=1024, height=1024,
#                    checkpoint_name="flux-dev-fp8.safetensors",
#                    lora_name='flux_lora/推文韩漫都市言情_V1.0.safetensors',)
# print(a)